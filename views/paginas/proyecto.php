<main class="main">
   <div class="proyecto">
      <h1 class="proyecto__titulo"><?php echo $title; ?></h1>
      <div class="proyecto__flex">
         <aside class="proyecto__sidebar">
